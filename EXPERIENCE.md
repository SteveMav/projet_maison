...
The local prototype at [`design/index.html`](design/index.html) and the imported Stitch detail reference at [`design/stitch-imports/detail-ngaliema/screen.png`](design/stitch-imports/detail-ngaliema/screen.png) illustrate decisions. The spines win if a mock conflicts with these documents.
...
| Lead detail/status | Lead list | Review listing provenance and update basic status | Assumption to confirm |
...
|---|---|---|
| Browse home | Local prototype `design/index.html`; Stitch project screen `Maison - Accueil et Recherche` | Mocked |
| Filtered results loading and empty | Local prototype; Stitch project screen `États de recherche` | Mocked |
| Listing detail | Stitch import `design/stitch-imports/detail-ngaliema/screen.png`; local drawer prototype | Mocked and reconciled |
...
| Moderator queue and checklist | No final visual reference | Spine-only |
| Lead detail/status | No final visual reference | Spine-only, pending MVP confirmation |
...
### Flow 1: Aline finds a credible rental option before spending her evening on calls
...
### Flow 2: Patrick publishes a useful listing from his phone
...
### Flow 3: Mireille verifies selectively without overpromising
...
### Flow 4: Serge reports a suspicious listing
